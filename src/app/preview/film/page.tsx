    ...
    <main className="min-h-screen bg-[var(--color-paper)] text-[var(--color-ink)]">
      <header className="max-w-6xl mx-auto px-6 pt-12 pb-6">
        ...
        <button
          ...
          className="mt-4 text-xs uppercase tracking-[0.18em] px-4 py-2 border border-[var(--color-rule)] hover:border-[var(--color-ink)] transition-colors"
        >
          Replay
        </button>
      </header>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 border-t border-[var(--color-rule)] text-sm text-[var(--color-ink-soft)] leading-relaxed">
        ...
        <p className="mt-6 mb-3 font-medium text-[var(--color-ink)]">Open questions for review</p>
