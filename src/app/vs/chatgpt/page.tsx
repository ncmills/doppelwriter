    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--color-border)] bg-[var(--color-surface-raised)]">
                  ...
                  <th className="text-left px-5 py-4 font-medium text-[var(--color-fg-muted)] w-1/3">ChatGPT</th>
                </tr>
              </thead>
        ...
        <section className="pb-16">
          ...
          <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-5 mb-6 text-sm text-[var(--color-fg-muted)] leading-relaxed">
            <p className="text-[var(--color-fg-muted)] text-xs uppercase tracking-wide mb-3">Prompt template</p>
            <p>
          ...
          <ul className="space-y-3 text-[var(--color-fg-muted)] mb-6">
            <li className="flex gap-3">
              <span className="text-[var(--color-brand)] shrink-0">&times;</span>
        ...
        <section className="pb-16">
          ...
          <h3 className="font-medium text-[var(--color-fg-muted)] mb-4">Popular use cases</h3>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <Link href="/write/cover-letter" className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-4 transition-colors hover:border-[var(--color-fg)] group">
              <p className="font-medium text-sm group-hover:text-[var(--color-brand)] transition-colors">Write My Cover Letter</p>
            </Link>
            <Link href="/write/blog-post" className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-4 transition-colors hover:border-[var(--color-fg)] group">
              <p className="font-medium text-sm group-hover:text-[var(--color-brand)] transition-colors">Write My Blog Post</p>
            </Link>
            <Link href="/write/wedding-speech" className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-4 transition-colors hover:border-[var(--color-fg)] group">
              <p className="font-medium text-sm group-hover:text-[var(--color-brand)] transition-colors">Write My Wedding Speech</p>
            </Link>
          </div>
        </section>
