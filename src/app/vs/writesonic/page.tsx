      ...
      <main className="max-w-4xl mx-auto px-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--color-border)] bg-[var(--color-surface-raised)]">
                  ...
                  <th className="text-left px-5 py-4 font-medium text-[var(--color-fg-muted)] w-1/3">Writesonic</th>
                </tr>
              </thead>
        ...
        <section className="pb-16">
          ...
          <ul className="space-y-2 text-[var(--color-fg-muted)]">
            ...
            <li>
              <Link href="/vs/copyai" className="text-[var(--color-brand)] hover:text-[var(--color-fg)] transition-colors">DoppelWriter vs Copy.ai</Link>
              <span className="text-[var(--color-fg-muted)]"> — brand voice playbooks vs personal voice cloning</span>
            </li>
          </ul>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Link href="/write/about-page" className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-4 transition-colors hover:border-[var(--color-fg)] group">
              <p className="font-medium text-sm group-hover:text-[var(--color-brand)] transition-colors">Write My About Page</p>
            </Link>
            <Link href="/write/newsletter" className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-4 transition-colors hover:border-[var(--color-fg)] group">
              <p className="font-medium text-sm group-hover:text-[var(--color-brand)] transition-colors">Write My Newsletter</p>
            </Link>
          </div>
        </section>
