  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)] flex items-center justify-center px-4">
      <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-8 w-full max-w-sm">
        <h1 className="text-2xl font-bold text-[var(--color-fg)] mb-6 text-center font-[family-name:var(--font-display)]">
        ...
        {showVerify ? (
          <div className="text-center py-4">
            ...
            <p className="text-[var(--color-fg-muted)] mb-2">We sent a verification link to</p>
            <p className="text-[var(--color-brand)] font-medium mb-4">{email}</p>
            <p className="text-[var(--color-fg-muted)] text-sm">Click the link to verify your account. Redirecting you now...</p>
          </div>
        ) : (
          <>
            <button
              onClick={() => { trackSignup("google"); signIn("google", { callbackUrl: "/onboarding" }); }}
              className="w-full py-3 border border-[var(--color-border)] hover:border-[var(--color-fg)] rounded-[2px] text-sm text-[var(--color-fg-muted)] hover:text-[var(--color-fg)] transition-colors flex items-center justify-center gap-3 mb-5"
            >
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs text-[var(--color-fg-muted)]">or sign up with email</span>
              <div className="flex-1 h-px bg-[var(--color-border)]" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-xs text-[var(--color-fg-muted)] -mt-2">Min 8 characters, with uppercase, lowercase, and a number</p>
