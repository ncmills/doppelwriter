...
export const metadata: Metadata = {
  title: "Terms of Service — DoppelWriter",
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold mb-3 font-[family-name:var(--font-literata)]">Terms of Service</h1>
        ...
        <div className="space-y-10 text-stone-300 leading-relaxed">
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">What DoppelWriter is</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Your account</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Acceptable use</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Your content</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Payment terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Service changes</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Termination</h2>
            <p>
              You can delete your account at any time by emailing <a href="mailto:enterprise@doppelwriter.com" className="text-amber-400 hover:underline">enterprise@doppelwriter.com</a>. We may terminate or suspend your account if you violate these terms. On termination, we&apos;ll delete your data per our <Link href="/privacy" className="text-amber-400 hover:underline">privacy policy</Link>.
            </p>
          </section>

          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Changes to these terms</h2>
            <p>
