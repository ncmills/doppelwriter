    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-16 space-y-6">
          ...
          <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-5">
            ...
            <div className="mt-2">
              ...
              <div className="h-2 bg-[var(--color-border)] rounded-[2px] overflow-hidden">
                <div
                  className="h-full bg-[var(--color-fg)] rounded-[2px]"
                  style={{
          ...
          <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-5">
            ...
            <div className="flex flex-wrap gap-2">
              {result.vocabulary.signatureWords.map((word) => (
                <span
                  key={word}
                  className="px-3 py-1.5 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[2px] text-[var(--color-brand)] text-sm font-medium"
                >
                  {word}
                </span>
              ))}
          ...
          <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-5">
            ...
            <ul className="space-y-2">
              {result.similarTo.map((writer) => (
                <li
                  key={writer}
                  className="text-[var(--color-fg)] text-sm leading-relaxed"
                >
            ...
            <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-5">
              ...
              <ul className="space-y-1.5">
                {result.personality.strengths.map((s) => (
                  <li
                    key={s}
                    className="text-sm text-[var(--color-fg)] flex items-start gap-2"
                  >
        ...
        <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-8 text-center">
          ...
          <Link
            href="/analyze"
            className="inline-block px-8 py-3 bg-[var(--color-fg)] text-[var(--color-surface)] hover:bg-[var(--color-brand)] rounded-[2px] font-semibold text-lg transition-colors"
          >
        ...
        <div className="text-center">
          ...
          <Link
            href="/signup"
            className="inline-block px-6 py-2.5 bg-[var(--color-surface-raised)] hover:bg-[var(--color-surface)] border border-[var(--color-border)] hover:border-[var(--color-fg)] rounded-[2px] text-sm font-medium transition-colors"
          >
