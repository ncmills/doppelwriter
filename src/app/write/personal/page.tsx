...
const CATEGORY_ID = "personal";
const CATEGORY_LABEL = "Casual & Personal";
const INTRO = "Life's big moments deserve your real voice. Wedding speeches, love letters, birthday messages, and more — written the way you actually talk.";
