    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          <h2 className="font-[family-name:var(--font-display)] text-2xl font-semibold mb-6">How It Works</h2>
        ...
        {related.length > 0 && (
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-2xl font-semibold mb-6">Related</h2>
