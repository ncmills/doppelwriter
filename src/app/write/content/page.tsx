...
const CATEGORY_ID = "content";
const CATEGORY_LABEL = "Creative Writing";
const INTRO = "Blog posts, essays, Substack newsletters, social threads, and scripts that carry your personality in every sentence. Create content that sounds like you.";
