  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-xl text-[var(--color-fg-muted)] mb-12 leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="text-[var(--color-fg-muted)] mb-4">Let your visitors check the tone of their emails before sending. Perfect for career blogs, communication courses, and HR sites.</p>
          <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-4 mb-4">
            <code className="text-sm text-[var(--color-brand)] break-all font-mono">
        ...
        <section className="mb-12">
          ...
          <p className="text-[var(--color-fg-muted)] mb-4">Let visitors analyze their writing voice — sentence patterns, vocabulary, tone. Great for writing courses and author websites.</p>
          <div className="bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-4 mb-4">
            <code className="text-sm text-[var(--color-brand)] break-all font-mono">
        ...
        <section className="mb-12 bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] p-6">
          ...
          <ul className="space-y-2 text-[var(--color-fg-muted)] text-sm">
        ...
        <section className="text-center py-8">
          <p className="text-[var(--color-fg-muted)] text-sm mb-4">Want a custom integration?</p>
          <a href="mailto:enterprise@doppelwriter.com" className="text-[var(--color-brand)] hover:text-[var(--color-fg)] transition-colors">
            Contact us &rarr;
          </a>
        </section>
      </main>
