      ...
      <nav className="border-b border-stone-800/40 sticky top-0 bg-[#0C0A09]/80 backdrop-blur-sm z-50">
        <div className="max-w-6xl mx-auto px-6 flex items-center h-14 justify-between">
          ...
          <div className="flex gap-4 items-center">
            ...
            <Link href="/login" className="text-sm text-stone-400 hover:text-white transition-colors">Log in</Link>
          </div>
        </div>
      </nav>

      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold mb-3 font-[family-name:var(--font-literata)]">Privacy Policy</h1>
        <p className="text-stone-500 text-sm mb-12">Last updated: March 2026</p>

        <div className="space-y-10 text-stone-300 leading-relaxed">
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">What we collect</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">How we handle your writing</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Gmail integration</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Payments</h2>
            <p>
              We use <a href="https://stripe.com/privacy" className="text-amber-400 hover:underline" target="_blank" rel="noopener noreferrer">Stripe</a> to process payments. Your credit card number never touches our servers. Stripe handles all payment data under their own PCI-compliant infrastructure.
            </p>
          </section>

          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Email communications</h2>
            <p>
              We send transactional emails (account verification, password resets, receipts) through <a href="https://resend.com/legal/privacy-policy" className="text-amber-400 hover:underline" target="_blank" rel="noopener noreferrer">Resend</a>. We don&apos;t send marketing emails unless you opt in, and you can unsubscribe from anything at any time.
            </p>
          </section>

          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Analytics</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Third parties</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Deleting your data</h2>
            <p>
              Want everything gone? Email <a href="mailto:enterprise@doppelwriter.com" className="text-amber-400 hover:underline">enterprise@doppelwriter.com</a> and we&apos;ll wipe your account, voice profiles, and any associated data. No hoops, no retention period.
            </p>
          </section>

          <section>
            <h2 className="font-[family-name:var(--font-literata)] text-xl font-semibold text-white mb-3">Changes to this policy</h2>
            <p>
