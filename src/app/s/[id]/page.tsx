  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        {draft.voice_name && (
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-[2px] mb-3">
              <span className="text-[var(--color-fg-muted)] text-sm">Written in the voice of</span>
              <span className="font-[family-name:var(--font-display)] font-bold text-[var(--color-brand)] text-lg">{draft.voice_name}</span>
            </div>
            <p className="text-[var(--color-fg-muted)] text-sm max-w-lg">
        ...
        {draft.voice_name && (
          <div className="mb-8">
            <Link
              href={voiceSignupUrl}
              className="inline-block px-6 py-2.5 bg-[var(--color-fg)] text-[var(--color-surface)] hover:bg-[var(--color-brand)] rounded-[2px] font-medium transition-colors text-sm"
            >
        ...
        <div className="mt-16 pt-8 border-t border-[var(--color-border)] text-center">
          <a
            ...
            className="inline-block text-[var(--color-fg-muted)] hover:text-[var(--color-brand)] text-xs tracking-wide uppercase mb-6 transition-colors"
          >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              ...
              className={draft.voice_name
                ? "inline-block px-8 py-3 border border-[var(--color-border)] hover:border-[var(--color-fg)] rounded-[2px] font-medium transition-colors text-[var(--color-fg-muted)] hover:text-[var(--color-fg)]"
                : "inline-block px-8 py-3 bg-[var(--color-fg)] text-[var(--color-surface)] hover:bg-[var(--color-brand)] rounded-[2px] font-medium transition-colors"
              }
            >
