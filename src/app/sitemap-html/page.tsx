    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 pb-16">
          {/* Main Pages */}
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-bold mb-4 text-[var(--color-brand)]">
              Main Pages
            </h2>
            <ul className="space-y-2">
              {MAIN_PAGES.map((page) => (
                <li key={page.href}>
                  <Link
                    href={page.href}
                    className="text-[var(--color-fg)] hover:text-[var(--color-brand)] transition-colors text-sm"
                  >
                    {page.label}
                  </Link>
                </li>
          ...
          <section>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  href="/for"
                  className="text-[var(--color-fg-muted)] hover:text-[var(--color-brand)] transition-colors text-xs"
                >
                  See all niches &rarr;
                </Link>
              </li>
