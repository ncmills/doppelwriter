...
related: []
faqs:
  - q: "Is it okay to use AI to write a character reference letter?"
    a: "Yes, as long as every fact in it is true and the final letter reflects your genuine opinion. AI is a drafting tool; you remain the author and the person vouching."
  - q: "Will people be able to tell I used AI?"
    a: "Only if you leave the default-AI tells in — generic praise, no specifics, a uniform tone. If you supply real anecdotes and edit it to sound like you, it reads as a normal, personal letter."
  - q: "Can I use AI for a character reference letter for court?"
    a: "You can use it to draft, but be especially careful: include only firsthand, observed examples, keep the tone sober and specific, and never overstate. A generic letter can hurt more than help."
  - q: "How long should a character reference letter be?"
    a: "One page — roughly 250 to 400 words. Two concrete examples and an honest assessment are enough."
  - q: "What should a character reference letter include?"
    a: "It answers four questions in order: who you are, how you know the person, what they're actually like with specific observed examples, and why you're recommending them."
---
